...
WebUI.selectOptionByLabel(findTestObject('Object Repository/Page_Swag Labs/select_Name (A to Z)Name (Z to A)Price (low to h'), 'Name (A to Z)', false)
...
println("Ekspektasi Urutan (A-Z): " + expectedSortedList)

if (actualProductNames.equals(expectedSortedList)) {
	println("Produk terurut")
} else {
	KeywordUtil.markFailed("Produk berantakan" + actualProductNames)
}