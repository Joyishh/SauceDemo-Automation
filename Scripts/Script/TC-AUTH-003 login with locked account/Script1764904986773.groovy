...
if(loginPageText.contains('Swag Labs')) {
	println('lanjut')
} else {
	WebUI.closeBrowser()
}
...
String lockedCredential = WebUI.getText(findTestObject('Object Repository/Page_Swag Labs/div_standard_userlocked_out_userproblem_use_68c467'))

if(lockedCredential.contains('Epic sadface: Sorry, this user has been locked out.')) {
	println('akunnya kekunci')
}
