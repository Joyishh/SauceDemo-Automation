...
WebUI.selectOptionByLabel(findTestObject('Object Repository/Page_Swag Labs/select_Name (A to Z)Name (Z to A)Price (low to h'), 'Price (high to low)', false)
...
println("Ekspektasi (High-Low): " + expectedSortedList)

if (actualPrices.equals(expectedSortedList)) {
	println("✅ PASS: Harga sudah urut dari Mahal ke Murah!")
} else {
